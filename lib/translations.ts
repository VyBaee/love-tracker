export const translations = {
  vi: {
    ...
    introScreen: {
      ...
      startBtn: 'Bắt đầu hành trình', githubBtn: 'Github', daysTogether: 'Đã bên nhau', days: 'ngày', newMemory: 'Kỷ niệm mới', justUploaded: 'Mới tải lên'
    },
    authExtra: {
      ticker: 'Hơn 50,000+ cặp đôi đã tìm thấy không gian hạnh phúc riêng...', feature1: 'Mã hóa đầu cuối', feature1Desc: 'Nhật ký và ảnh của hai bạn được bảo mật tuyệt đối.',
      feature2: 'Đồng bộ Realtime', feature2Desc: 'Nhận lời mời và cảm xúc của người ấy ngay lập tức.', feature3: 'Gợi ý câu hỏi AI', feature3Desc: 'Mỗi ngày một câu hỏi hâm nóng tình cảm tự động.',
      quote: '“Tình yêu không phải là nhìn nhau, mà là cùng nhau nhìn về một hướng.”', premium: 'Trải nghiệm cao cấp', title: 'Không gian số lưu trữ trọn vẹn hồi ức của hai người.'
    },
  },
  ...
  en: {
    ...
    introScreen: {
      ...
      startBtn: 'Start your journey', githubBtn: 'Github', daysTogether: 'Days Together', days: 'days', newMemory: 'New Memory', justUploaded: 'Just uploaded'
    },
    authExtra: {
      ticker: 'Over 50,000+ couples have found their private happy space...', feature1: 'End-to-end encryption', feature1Desc: 'Your shared diary and photos are completely secure.',
      feature2: 'Realtime sync', feature2Desc: 'Receive your partner’s invitations and moods instantly.', feature3: 'AI prompt suggestions', feature3Desc: 'A daily question to spark your connection, automatically generated by AI.',
      quote: '“Love does not consist in gazing at each other, but in looking outward together in the same direction.”', premium: 'Premium Experience', title: 'A digital space that perfectly preserves your shared memories.'
    },
  }
};
